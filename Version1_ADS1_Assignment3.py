...
csv_file1_pca = pca.transform(df1)

print(csv_file1_pca)

plt.scatter(csv_file1_pca[:,0],csv_file1_pca[:,0])
...
popt, pcov = curve_fit(func_logistic, csv_file1_pca[:, 0], csv_file1_pca[:, 0])

plt.scatter(csv_file1_pca[:, 0], csv_file1_pca[:, 0], color='red')
